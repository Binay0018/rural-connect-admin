    ...
    <Sidebar collapsible="icon" className="border-r-0">
      ...
      <SidebarFooter className="border-t border-sidebar-border px-2 py-3">
        <SidebarMenu>
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <button className="flex w-full items-center gap-2.5 rounded-md px-2.5 py-2 text-sm text-sidebar-foreground hover:bg-destructive/10 hover:text-destructive transition-colors">
